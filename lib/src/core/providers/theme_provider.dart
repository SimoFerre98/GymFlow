...
class ThemeSettings {
  const ThemeSettings({
    ...
    this.themeStyle = AppThemeStyle.toxicForest,
    this.primaryColor = defaultPrimaryColor,
    this.hapticFeedback = true,
  });
  /// Giallo neon: il colore delle azioni della palette Toxic Forest.
  static const Color defaultPrimaryColor = AppPalette.accent;
...
class ThemeSettingsNotifier extends _$ThemeSettingsNotifier {
  ...
  /// Cambia palette e riporta il colore delle azioni al suo predefinito: un
  /// accento della palette precedente potrebbe non stare nei preset di
  /// quella nuova.
