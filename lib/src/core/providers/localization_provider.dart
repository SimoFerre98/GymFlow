...
class Localization {
  ...
  static final Map<String, String> _en = {
    ...
    'permissions_denied_settings': 'Permission denied. Tap to open app settings.',
    'permissions_request_failed': 'Could not request health permissions.',
    ...
    // Connect Friend (US-087: invito, non più amicizia istantanea)
    ...
    'your_friends_list': 'Your Connections',
    'no_friends_msg': 'No connections yet. Invite someone!',
    'done': 'DONE',
    'cant_add_self': "You can't invite yourself!",
    'invite_sent_msg': 'Invite sent!',
    'invite_code_not_found': 'No one found with that code',
    'incoming_invites_title': 'Invites received',
    'no_incoming_invites': 'No invites waiting',
    'outgoing_invites_title': 'Invites sent',
    'no_outgoing_invites': 'No pending invites',
    'accept_invite': 'Accept',
    'decline_invite': 'Decline',
    'cancel_invite': 'Cancel',
    'dissolve_connection': 'Remove',
    'confirm_dissolve_msg': 'Remove connection with %s?',
    'invited_you_msg': '%s invited you',
    'invite_expired_label': 'Expired',
    'invite_pending_msg': 'Waiting for response',
    'connection_dissolved_msg': 'Connection removed',
    'invite_declined_msg': 'Invite declined',
    'invite_accepted_msg': 'Invite accepted!',
    'invite_cancelled_msg': 'Invite cancelled',
    'connection_since': 'Connected since %s',
    // Program List
    ...
    'editing_measurement_notice': 'Editing a past measurement',
    'delete_measurement_title': 'Delete measurement?',
    'delete_measurement_body': 'This entry will be permanently removed.',
    ...
    'goal_deadline_passed': 'Deadline passed',
    ...
    'home_suggested_badge_prefix': 'Suggested',
  ...
  static final Map<String, String> _it = {
    ...
    'permissions_denied_settings': 'Permesso negato. Tocca per aprire le impostazioni dell\'app.',
    'permissions_request_failed': 'Non è stato possibile richiedere i permessi di salute.',
    ...
    'send_invite_btn': 'INVIA INVITO',
    'your_friends_list': 'Le tue Connessioni',
    'no_friends_msg': 'Ancora nessuna connessione. Invita qualcuno!',
    'done': 'FATTO',
    'cant_add_self': 'Non puoi invitare te stesso!',
    'invite_sent_msg': 'Invito inviato!',
    'invite_code_not_found': 'Nessuno trovato con questo codice',
    'incoming_invites_title': 'Inviti ricevuti',
    'no_incoming_invites': 'Nessun invito in attesa',
    'outgoing_invites_title': 'Inviti inviati',
    'no_outgoing_invites': 'Nessun invito in sospeso',
    'accept_invite': 'Accetta',
    'decline_invite': 'Rifiuta',
    'cancel_invite': 'Annulla',
    'dissolve_connection': 'Rimuovi',
    'confirm_dissolve_msg': 'Sciogliere il legame con %s?',
    'invited_you_msg': '%s ti ha invitato',
    'invite_expired_label': 'Scaduto',
    'invite_pending_msg': 'In attesa di risposta',
    'connection_dissolved_msg': 'Legame sciolto',
    'invite_declined_msg': 'Invito rifiutato',
    'invite_accepted_msg': 'Invito accettato!',
    'invite_cancelled_msg': 'Invito annullato',
    'connection_since': 'Connesso dal %s',
    // Program List
    ...
    'measurement_updated': 'Misurazione aggiornata',
    'measurement_deleted': 'Misurazione eliminata',
    'update_action': 'Aggiorna',
    'editing_measurement_notice': 'Stai modificando una misura passata',
    'delete_measurement_title': 'Eliminare la misurazione?',
    'delete_measurement_body': 'Questo dato verrà rimosso definitivamente.',
    ...
    'goal_deadline_passed': 'Scadenza passata',
    ...
    'home_suggested_badge_prefix': 'Suggerito',
