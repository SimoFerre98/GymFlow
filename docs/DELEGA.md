...
| Gli avvisi dell'analyzer non superano 56 | **nessuno**: si controlla a mano | ⬜ da fare, richiede una modifica alla CI |
...
- verifica con:
  ...
  analyze deve dare 56 o meno. Se sale, hai introdotto qualcosa: sistemalo.
...
analyze:     <numero> avvisi   (baseline 56)
test:        <numero> verdi    (erano 440)
